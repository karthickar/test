...
terraform apply -var "access_key=${AWS_ACCESS_KEY}" -var "secret_key=${AWS_SECRET}" -var "aws_key_pair_name=${AWS_KEY_PAIR_NAME}" -var 'region=us-east-1' -var "app_name=${APP}" -var "environment=${ENV}" -var "instance_type=${SIZE}"
